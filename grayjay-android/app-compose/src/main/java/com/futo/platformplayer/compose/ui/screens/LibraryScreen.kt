...
fun LibraryScreen(
    ...
    val filteredVideos = videosForLibraryFilter(videos, selectedFilter, downloads)
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        item {
            Row(
                ...
                Text(stringResource(selectedFilter.labelRes), style = MaterialTheme.typography.titleLarge)
        ...
        if (selectedFilter == LibraryFilter.Playlists) {
            ...
            itemsIndexed(
                ...
                VideoCard(
                    ...
                    selected = selectedFilter == LibraryFilter.History && video.id in selectedVideoIds,
                    showProgress = selectedFilter == LibraryFilter.History,
                    onClick = {
                        if (selectedFilter == LibraryFilter.History && selectionMode) {
        ...
        if (
            ...
            (selectedFilter != LibraryFilter.Playlists && filteredVideos.isEmpty())
        ) {
            item {
                Text(
